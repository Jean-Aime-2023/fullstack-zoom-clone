  ...
  return (
    <div className="flex size-full flex-col gap-10 text-white mt-10">
      <section className="flex flex-row items-center justify-between">
        ...
        <button
          className="lg:text-[18px] md:text-[15px] text-sm hover:underline hover:underline-offset-2 cursor-pointer text-[#ECF0FF]"
      ...
      <div className="grid grid-cols-1 gap-5 xl:grid-cols-2">
        {calls && calls.length > 0 ? (
          <>
            {calls
              .slice(0, showMore ? calls.length : 2)
